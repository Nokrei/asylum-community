    ...
    <animated.div className="about white-font" id="about">
      ...
      >
       ...
       <br/>
        ...
        <br />
        <br />
        There should only be one thing that comes to mind when you hear those in
        succession...
      </div>
      ...
      >
        ...
        and looking for a chat? Wanna watch movies with friends? Join any voice
        channel and a gorgeous e girl is guaranteed to join you!
        <br />
        <br />
      ...
      <div className="button__container">
        ...
        <div className="circle__container">
          ...
          <div onClick={handleCircleThree} className={circleClass.three}></div>
        </div>
